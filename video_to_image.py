...
# Exemplo de uso
video_path = "C:/Users/vrmsb/Pictures/Camera Roll/xiaomi10.mp4"  # Substitua pelo caminho do seu vídeo
output_folder = "xiaomi10"      # Pasta onde as imagens serão salvas
